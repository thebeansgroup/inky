...
/**
 * 
 * @param {object} components - List of custom components
 * @returns {object} Component names to pass to `inky` function
 */
Inky.createCustomComponents = function(components) {
  var componentList = {}, name;

   for (name in components) {
     Inky.prototype.componentLibrary[name] = components[name].js;
